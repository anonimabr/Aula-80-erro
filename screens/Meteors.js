...
import { Text, View, Alert, SafeAreaView, FlatList, 
    ImageBackground, Image, Dimensions, StyleSheet } from 'react-native';
...
export default class MeteorScreen extends Component {
            ...
            <View>
                <ImageBackground source={bg_img} style ={styles.backgroundImage}>
                    <View style={styles.gifContainer}>
                        ...
                        <View>
                            <Text style={[styles.cardText, {marginTop: 400, marginLeft:50}]}>{item.name}</Text>
    ...
    render() {
        if (Object.keys(this.state.meteors).length === 0) {
            ...
            //5 objetos
            //1- qdo passou mais prox da Terra
            //2- Diam max
            //3- Diam min
            //4- Velocidade
            //5- Distancia da Terra

            //aqui classificando os objetos API em ordem decrescente com base na pontuação
            meteors.sort(function(a,b){
                return b.threat_score - a.threat_score
            })

            //pegando de fato os 5 objetos
